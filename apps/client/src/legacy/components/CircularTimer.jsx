      ...
      <svg className="circular-timer-svg" width={size} height={size} style={{ overflow: 'visible' }}>
        <defs>
          ...
          <linearGradient id="greenGradient" x1="0%" y1="0%" x2="100%" y2="100%">
            <stop offset="0%" stopColor="#b7e9ed" stopOpacity="1" />
            <stop offset="30%" stopColor="#6fd4dc" stopOpacity="1" />
            <stop offset="60%" stopColor="#4ecdd6" stopOpacity="1" />
            <stop offset="100%" stopColor="#3bc0cb" stopOpacity="1" />
          </linearGradient>
          ...
          <radialGradient id="centerGreenRadial" cx="35%" cy="35%">
            <stop offset="0%" stopColor="#dff6f8" stopOpacity="1" />
            <stop offset="40%" stopColor="#6fd4dc" stopOpacity="1" />
            <stop offset="70%" stopColor="#4ecdd6" stopOpacity="1" />
            <stop offset="100%" stopColor="#3bc0cb" stopOpacity="1" />
          </radialGradient>
