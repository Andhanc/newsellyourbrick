  ...
  return createPortal(
    <>
      <button
        ...
        aria-label={t('newsPage_subCloseAria')}
      />
      <div
      ...
      >
        ...
        >
          ...
          <button
            ...
            onClick={() => requestClose()}
            aria-label={t('newsPage_subClose')}
          >
            <FiX size={20} />
          </button>
            ...
            {submitted ? (
              ...
              >
                ...
                <div className="news-subscription-drawer__success-copy">
                  <p className="news-subscription-drawer__eyebrow">
                    {t('newsPage_subActiveEyebrow')}
                  </p>
                  <h2 id="news-subscription-title">{t('newsPage_subActiveTitle')}</h2>
                  <p id="news-subscription-description" className="news-subscription-drawer__lead">
                    {t('newsPage_subActiveLead', { email })}
                  </p>
                  <button
                    type="button"
              ...
              <>
                ...
                <p className="news-subscription-drawer__eyebrow">
                  {t('newsPage_mastheadEyebrow')}
                </p>
                <h2 id="news-subscription-title">{t('newsPage_subTitle')}</h2>
                <p id="news-subscription-description" className="news-subscription-drawer__lead">
                  {t('newsPage_subLead')}
                </p>
                ...
                <form className="news-subscription-drawer__form" onSubmit={handleSubmit}>
                  <label className="news-subscription-drawer__field">
                    <span>{t('newsPage_subEmailLabel')}</span>
                  ...
                  <label className="news-subscription-drawer__consent">
                    <input
                      ...
                      required
                    />
                    <span>{t('newsPage_subConsent')}</span>
                  </label>
                  ...
                  >
                    ...
                    {t('newsPage_subConfirm')}
                  </button>
                  <p className="news-subscription-drawer__privacy">
                    {t('newsPage_subUnsubscribeHint')}
                  </p>
                </form>
              </>
            )}
