...
function getAuctionCardActionGroup(property, viewerHasVip) {
  ...
  const isVipPresentation =
    viewerHasVip &&
    isPrivateClubAuctionLot(property) &&
    !listingState.blocksBid &&
    !listingState.blocksPurchase &&
    !listingEnded &&
    !isReserved

  if (listingState.blocksBid || isVipPresentation) return 2

  const hasSecondAction =
    hasBuyNowOption(property) &&
    !listingState.blocksPurchase &&
    !listingEnded

  return hasSecondAction ? 0 : 1
}
