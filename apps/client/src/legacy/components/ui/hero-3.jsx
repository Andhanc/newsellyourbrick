    ...
    >
      <div className="animated-marquee-hero__copy z-10 flex flex-col items-center">
        {tagline ? (
          ...
          >
            <span className="flex h-8 w-8 shrink-0 items-center justify-center rounded-full bg-[linear-gradient(135deg,#0099A9_0%,#007d8a_100%)] text-white shadow-[0_2px_8px_rgba(10,186,181,0.4)]">
