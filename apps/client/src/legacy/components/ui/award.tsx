...
export function Awards({
  ...
  if (variant === 'award') {
    const LaurelWreath = () => (
      ...
      >
        <svg
          className={cn(
            'fill-white block h-auto w-[min(88vw,440px)] max-w-none drop-shadow-[0_1px_2px_rgba(0,0,0,0.35)] sm:w-[min(82vw,480px)]'
          )}
    ...
    return (
      <div
        className={cn(
          ...
          'flex min-h-[min(340px,62vw)] flex-col items-center justify-center px-4 py-6 sm:min-h-[min(380px,48vh)] sm:px-6 sm:py-8',
          className
        )}
      >
        <LaurelWreath />
        <div className="relative z-10 mx-auto max-w-[min(18rem,86vw)] px-3 text-center sm:max-w-[min(20rem,82vw)] sm:px-6">
          <h1 className="mt-4 text-2xl leading-tight font-black tracking-tight text-white drop-shadow-sm sm:mt-5 sm:text-3xl">
            {title}
          </h1>

          <div className="mx-auto my-2 h-px w-28 bg-white opacity-90 sm:w-32" />

          {subtitle ? (
            <h2 className="mb-3 w-full text-balance text-base font-light leading-snug text-white sm:text-lg">
              {subtitle}
            </h2>
          ) : null}

          {recipient && (
            <p className="text-xs italic text-white/95 sm:text-sm">{recipient}</p>
          )}
  ...
  if (variant === 'certificate') {
    ...
    return (
      <div
        className={cn(
          'relative z-0',
          'flex flex-col items-center justify-center rounded-xl border-2 border-dotted border-slate-300 p-2',
          'overflow-hidden',
          className
        )}
      >
        <div className="bg-white z-10 rounded-sm border border-slate-200 p-6 px-8 text-center dark:bg-slate-900">
          <Badge />
          <h1
            className={cn(
          ...
          <p className="mt-4 mb-1 text-xs text-slate-500">
          ...
          <p className="mb-1 text-xs text-slate-500">{subtitle}</p>
      ...
      <div className={cn('', className)}>
        ...
        >
          ...
          <div className={cn('border-l px-3')}>
            ...
            <h2 className={cn('text-md text-slate-500 font-light')}>
              {subtitle}
            </h2>
  ...
  if (variant === 'id-card') {
    return (
      <div
        className={cn(
          'bg-card flex items-center justify-center rounded-md border border-slate-200 bg-white p-1 shadow-lg dark:bg-slate-900',
          className
        )}
      >
        <div className="relative h-96 w-72 overflow-hidden rounded-sm border-4">
          ...
          <div className="mt-24 px-6">
            <div
              className={cn(
                'bg-secondary mb-4 w-fit rounded-md border border-slate-200 px-4 py-2 text-xs dark:bg-slate-800'
              )}
            >
              {date}
            </div>
            <h1 className="text-5xl leading-tight font-bold">{title}</h1>
            <p className="-mt-2 text-md font-light tracking-wider text-slate-500">
              {subtitle}
            </p>
          </div>
