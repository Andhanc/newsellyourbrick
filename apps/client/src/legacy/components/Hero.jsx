...
const AUCTION_HERO_BG = publicAsset('images/sellyourbrick/about/mission-villa.jpg')
  ...
  const FEATURES = [
    {
      ...
      img: publicAsset('images/external/icon-1-17dab2f77576179c-14e3e1ef79.png'),
    ...
    },
    {
      ...
      img: publicAsset('images/external/icon-3-be34334d56e4527b-7e5b2f6844.svg'),
