...
## Router and framework

React Router v6 is configured centrally in `src/App.jsx` under a single `BrowserRouter`. Every route is hosted by the global provider stack and scroll-owning `AppLayoutFrame`; route-specific pages decide whether to render the shared `Header`, a route-owned mobile app bar, or a map/detail shell.

## Buyer routes

| URL | Component | Layout | Purpose |
|---|---|---|---|
| / | src/pages/home-redesign/HomeRedesignPage.jsx | Global app shell + route-owned home layout | Buyer/investor landing and discovery home. |
| /auction | src/pages/Home.jsx | Global Header + dense commerce catalogue | Primary live auction catalogue. |
| /auction/:segment1/:segment2? | src/pages/Home.jsx | Global Header + dense commerce catalogue | Auction filtered by country/city/segment. |
| /auction/property/:slugOrId | src/pages/PropertyDetailPage.jsx | Photo-first detail layout | Auction detail compatibility route. |
| /property/:slugOrId | src/pages/PropertyDetailPage.jsx | Photo-first detail layout | Canonical property detail. |
| /auction/:country/:city/property/:slugOrId | src/pages/PropertyDetailPage.jsx | Photo-first detail layout | SEO auction property detail. |
| /debts/:country/:city/property/:slugOrId | src/pages/PropertyDetailPage.jsx | Photo-first detail layout | Debt property detail. |
| /search-results/:country/:city/property/:slugOrId | src/pages/PropertyDetailPage.jsx | Photo-first detail layout | Search-result property detail. |
| /test-drive | src/pages/TestDriveLandingPage.jsx | Immersive route-owned mobile app bar + catalogue | Test-drive discovery. |
| /property/:slugOrId/test-drive | src/pages/TestDriveBookingPage.jsx | Guided booking flow | Book a test drive for a property. |
| /test-drive/survey/:token | src/pages/TestDriveSurveyPage.jsx | Guided form | Pre-visit survey. |
| /test-drive/feedback/:token | src/pages/TestDriveExitFeedbackPage.jsx | Guided form | Post-visit feedback. |
| /profile/bookings/:bookingId/check-in | src/pages/TestDriveCheckInRoute.jsx | Guided booking flow | Booking check-in. |
| /search-results | src/pages/SearchResults.jsx | Global Header + dense commerce catalogue | Buyer search results. |
| /search-results/:country | src/pages/SearchResults.jsx | Global Header + dense commerce catalogue | Country search results. |
| /search-results/:country/:city | src/pages/SearchResults.jsx | Global Header + dense commerce catalogue | City search results. |
| /:country/:city/:typePlural? | src/pages/CatalogCityPage.jsx | Global Header + city storefront | SEO city/type catalogue; keep after explicit routes. |
| /map | src/pages/MapPage.jsx | Map-first canvas + results sheet | Property map discovery. |
| /favorites | src/pages/Favorites.jsx | Global Header + curated shortlist | Saved buyer properties and comparison entry. |
| /compare | src/pages/Compare.jsx | Decision cockpit | Property comparison and decision summary. |
| /debts | src/pages/Debts.jsx | Global Header + fintech marketplace | Debt-backed property marketplace. |
| /co-investment | src/pages/Shares.jsx | Global Header + fintech marketplace | Co-investment catalogue. |
| /co-investment/:slugOrId | src/pages/ShareDetailPage.jsx | Photo-first financial detail | Co-investment detail. |
| /co-investment/:country/:city/property/:slugOrId | src/pages/ShareDetailPage.jsx | Photo-first financial detail | SEO co-investment detail. |
| /wallet | src/pages/Wallet.jsx | Guided financial dashboard | Buyer balance, deposit and transactions. |
| /deposit | src/components/DepositRedirect.jsx | Redirect into wallet deposit state | Backward-compatible deposit entry. |
| /calculator | src/pages/InvestmentCalculator.jsx | Guided financial flow | Smart-investor calculator. |
| /profile | src/components/CabinetProfileRoute.jsx → src/pages/TestPage.jsx | Buyer cabinet shell | Buyer account home; seller role redirects. |
| /profile/bookings | src/pages/MyBookingsPage.jsx | Account and inbox | Test-drive bookings. |
| /profile/purchased/:propertyId | src/pages/PurchasedObjectGuidePage.jsx | Guided post-purchase flow | Purchased-property next steps. |
| /subscriptions | src/pages/Subscriptions.jsx | Buyer cabinet/account | Subscription plans and status. |
| /history | src/pages/History.jsx | Account timeline | Buyer activity and transaction history. |
| /chat | src/pages/Chat.jsx | Account inbox | Conversation/support route. |
| /bonuses | src/pages/Bonuses.jsx | Editorial rewards campaign | Buyer bonuses and referrals. |
| /private-club | src/pages/PrivateClub.jsx | Premium editorial campaign | Private-club offer and access. |
| /sections | src/pages/SectionsPage.jsx | Mobile navigation hub | Entry to service sections. |
| /buyer | src/pages/BuyerPage.jsx | Editorial buyer campaign | Buyer-facing marketing/instruction page. |
| /news | src/pages/News.jsx | Editorial magazine | News index. |
| /news/:slug | src/pages/NewsArticlePage.jsx | Editorial article | News detail. |
| /about | src/pages/About.tsx | Brand storytelling | About SellYourBrick. |
| /sellyourbrick | src/pages/SellYourBrickLandingPage.jsx | Brand campaign | General service landing. |
| /shares | src/components/LegacySharesRedirect.jsx | Redirect | Legacy alias to /co-investment. |
| /shares/:slugOrId | src/components/LegacySharesRedirect.jsx | Redirect | Legacy detail alias. |
