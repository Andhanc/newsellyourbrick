...
test('buyer mobile tokens expose the approved commercial design system', () => {
  ...
  assert.match(css, /--buyer-teal:\s*#0099a9/i)
  assert.match(css, /--buyer-teal-deep:\s*#006f7b/i)
  assert.match(css, /--buyer-mint:\s*#eaf8f5/i)
  assert.match(css, /--buyer-warm:\s*#faf8f5/i)
  assert.match(css, /--buyer-cloud:\s*#f3f6f5/i)
  assert.match(css, /--buyer-auction:\s*#f4d63e/i)
  assert.match(css, /--buyer-font-display:\s*['"]Montserrat/i)
  assert.match(css, /--buyer-font-body:\s*['"]Inter/i)
