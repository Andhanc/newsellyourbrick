...
export function OwnerOnboardingStep1Illustration({ className = '' }) {
  return (
    <StepIllustrationShell className={className} gradId="owner-onb-bg-1">
      <ellipse cx="195" cy="252" rx="120" ry="10" fill="#0abab5" fillOpacity="0.12" />
      <rect x="48" y="48" width="294" height="176" rx="20" fill="#fff" stroke="#e5e7eb" strokeWidth="2" />
      <rect x="68" y="68" width="88" height="12" rx="6" fill="#ecfdf5" />
      ...
      <rect x="78" y="132" width="36" height="8" rx="4" fill="#ccfbf1" />
      <rect x="166" y="132" width="36" height="8" rx="4" fill="#fce7f3" />
      <rect x="254" y="132" width="36" height="8" rx="4" fill="#fef3c7" />
      <circle cx="104" cy="168" r="14" fill="#0abab5" fillOpacity="0.18" />
...
export function OwnerOnboardingStep2Illustration({ className = '' }) {
  return (
    <StepIllustrationShell className={className} gradId="owner-onb-bg-2">
      ...
      <rect x="76" y="76" width="100" height="12" rx="6" fill="#ecfdf5" />
      <defs>
        <linearGradient id="owner-onb-chart-fill-2" x1="188" y1="96" x2="188" y2="188" gradientUnits="userSpaceOnUse">
          <stop stopColor="#0abab5" stopOpacity="0.22" />
          <stop offset="1" stopColor="#0abab5" stopOpacity="0" />
        </linearGradient>
      </defs>
      <path
      ...
      />
      <circle cx="128" cy="148" r="5" fill="#fff" stroke="#0abab5" strokeWidth="2" />
      <circle cx="208" cy="118" r="5" fill="#fff" stroke="#0abab5" strokeWidth="2" />
      <circle cx="288" cy="96" r="5" fill="#fff" stroke="#0abab5" strokeWidth="2" />
    </StepIllustrationShell>
  )
}
...
export function OwnerOnboardingStep3Illustration({ className = '' }) {
  return (
    <StepIllustrationShell className={className} gradId="owner-onb-bg-3">
      ...
      <rect x="92" y="182" width="168" height="8" rx="4" fill="#ecfdf5" />
      <rect x="228" y="160" width="70" height="32" rx="10" fill="#0abab5" fillOpacity="0.15" />
    </StepIllustrationShell>
  )
}
