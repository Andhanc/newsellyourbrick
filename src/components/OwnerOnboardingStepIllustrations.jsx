...
export function OwnerOnboardingStep1Illustration({ className = '' }) {
  return (
    <StepIllustrationShell className={className} gradId="owner-onb-bg-1">
      <ellipse cx="195" cy="252" rx="120" ry="10" fill="#4a90a2" fillOpacity="0.12" />
      ...
      <circle cx="104" cy="168" r="14" fill="#4a90a2" fillOpacity="0.18" />
    ...
    <StepIllustrationShell className={className} gradId="owner-onb-bg-2">
      ...
      <defs>
        <linearGradient id="owner-onb-chart-fill-2" x1="188" y1="96" x2="188" y2="188" gradientUnits="userSpaceOnUse">
          <stop stopColor="#4a90a2" stopOpacity="0.22" />
          <stop offset="1" stopColor="#4a90a2" stopOpacity="0" />
        </linearGradient>
      </defs>
      <path
      ...
      />
      <circle cx="128" cy="148" r="5" fill="#fff" stroke="#4a90a2" strokeWidth="2" />
      <circle cx="208" cy="118" r="5" fill="#fff" stroke="#4a90a2" strokeWidth="2" />
      <circle cx="288" cy="96" r="5" fill="#fff" stroke="#4a90a2" strokeWidth="2" />
    </StepIllustrationShell>
  )
}
...
export function OwnerOnboardingStep3Illustration({ className = '' }) {
  return (
    <StepIllustrationShell className={className} gradId="owner-onb-bg-3">
      ...
      <rect x="228" y="160" width="70" height="32" rx="10" fill="#4a90a2" fillOpacity="0.15" />
    </StepIllustrationShell>
  )
}
