...
test('catalog falls back to one readable card per row on the narrowest phones', () => {
  assert.match(auctionCss, /@media\s*\(max-width:\s*374px\)[\s\S]*grid-template-columns:\s*minmax\(0,\s*1fr\)/)
