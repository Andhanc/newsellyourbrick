...
const DepositTopUpPicker = ({ isOpen, onClose, onSelectCard, onSelectCrypto }) => {
  if (!isOpen) return null

  return (
    <div className="deposit-picker-overlay" onClick={onClose}>
      <div className="deposit-picker" onClick={e => e.stopPropagation()}>
        <button type="button" className="deposit-picker__close" onClick={onClose} aria-label="Закрыть">
