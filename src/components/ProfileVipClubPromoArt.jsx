  ...
  return (
    ...
    >
      ...
      <g className="profile-vip-club-promo-art__float profile-vip-club-promo-art__float--3" transform="translate(228 118) rotate(-18)">
        <circle cx="14" cy="14" r="11" fill="#f0fafb" stroke="#134e4a" strokeWidth="1.8" />
        <circle cx="14" cy="14" r="4.5" fill="#cce9ed" stroke="#134e4a" strokeWidth="1.4" />
        <rect x="22" y="11" width="34" height="6" rx="3" fill="#e6f6f8" stroke="#134e4a" strokeWidth="1.6" />
        <rect x="48" y="8" width="5" height="12" rx="2" fill="#f0fafb" stroke="#134e4a" strokeWidth="1.4" />
        <rect x="40" y="8" width="5" height="9" rx="2" fill="#f0fafb" stroke="#134e4a" strokeWidth="1.4" />
      </g>
      ...
      <g className="profile-vip-club-promo-art__float profile-vip-club-promo-art__float--4" transform="translate(52 112) rotate(12)">
        ...
        <rect x="24" y="10" width="22" height="4" rx="2" fill="#cce9ed" />
        <rect x="24" y="18" width="16" height="3" rx="1.5" fill="#e6f6f8" stroke="#134e4a" strokeWidth="1" />
      </g>
      ...
      <g className="profile-vip-club-promo-art__hero" transform="translate(118 18) rotate(-8)">
        ...
        <path
          ...
          strokeWidth="2.2"
        />
        <circle cx="74" cy="98" r="28" fill="#e6f6f8" stroke="#134e4a" strokeWidth="2" />
        <path
