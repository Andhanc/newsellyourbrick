...
test('wallet header actions use stable destinations and the notifications drawer', () => {
  ...
  assert.match(wallet, /<SiteNavDrawer/)
  assert.match(wallet, /setSiteNavDrawerOpen\(walletMenuOpen\)/)
  assert.doesNotMatch(wallet, /wallet-bank__menu-popover/)
  assert.doesNotMatch(wallet, /walletPage_greeting/)
