...
const sellerServiceCards: SellerCard[] = [
  {
    icon: FiBarChart2,
    title: 'Оценка лота',
    copy: 'Получите прозрачную картину по цене, спросу и потенциалу объекта до публикации.',
  },
  {
    icon: FiLayers,
    title: 'Маркетинг объекта',
    copy: 'Соберите презентацию, медиа и сценарий показа под нужный формат сделки.',
    accent: true,
  },
  {
    icon: FiTarget,
    title: 'Закрытие сделки',
    copy: 'Ведите переговоры и статусы до финала — с понятными шагами для всех сторон.',
  },
]
  ...
  return (
    <section className="seller-services" aria-labelledby="seller-services-title">
      ...
      <div className="seller-services__head">
        ...
        <p>
          От первой оценки объекта до закрытия сделки — один сценарий, понятные шаги и прозрачные
          цифры на каждом этапе.
        </p>
      </div>
