...
test('mobile property map card stays mirrored and smartphone-scoped', async () => {
  ...
  assert.match(webMapSource, /onSatelliteOpen=\{openSatellite\}/)
  assert.match(webMapSource, /mode="satellite"/)
  assert.match(webMapSource, /const \[satelliteOpen, setSatelliteOpen\] = useState\(false\)/)
